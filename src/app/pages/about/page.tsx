...
function About() {
	return (
		<div className=' m-5 p-4'>
			{data.map((val) => (
				<div key={val.id} className=" m-6 p-5  bg-white/30 rounded-xl shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]    text-lg  leading-relaxed">
					<h2 className="text-2xl text-center font-medium m-3 underline">{val.title}</h2>
					<p>{val.description}</p>
				</div>
			))}
		</div>
